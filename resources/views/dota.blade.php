...
<head>
    ...
    <title>Dota 2 | Gamersleague | Techfest IIT Bombay</title>
        ...
        <div class="nk-store-product">
            <div class="row xl-gap equal-height vertical-gap">
                        ...
                        <div>
                            <div class="nk-carousel-3" data-size="1">
                                <div class="nk-carousel-inner nk-popup-gallery">
                                    <div>
                                        <div>
                                            <a href="images/dota.jpg" class="nk-gallery-item" data-size="780x990">
                                                <img src="images/dota.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            <a href="images/dota.jpg" class="nk-gallery-item" data-size="780x990" style="background:black">
                                                <img src="images/dota.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="col-md-7">
                    <div class="nk-vertical-center">
                        <div>
                            <h2 class="nk-product-title">Dota 2</h2>
                            <div class="nk-product-description">
                                <p>
                                    Techfest summons Gamers from all over India for this Huge Tournament who will battle it out for Prizes Worth of 2 Lakhs for Dota 2.
                                </p>
                                <p>
                                    The event consists of both online qualifiers and LAN Playoffs. All Teams will play knockout matches online (Bo1) and will progress to further rounds. Top 8 teams will then be invited for the LAN PLayoffs at Techfest, IIT Bombay during 14th-16th December. Semi-Finals and Finals will both be Bo3.
                                </p>
                                <p>
                                    <b>
                            ...
                            @elseif($player!==null && $dota!==null)
                                <form action="#" class="nk-form nk-product-addtocart">
                                    @if($dota->leader===$player->steamid)
                                        <button class="nk-btn nk-btn-x2" data-toggle="modal" data-target=".manage-team">Manage Team</button>
                                    @else
                                        <button class="nk-btn nk-btn-x2" data-toggle="modal" data-target=".manage-team">See Team</button>
                                    @endif
                                    <span class="nk-product-price">INR 2,00,000</span>
                                </form>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title nk-title display-4" id="myLargeModalLabel">Manage Team</h4>
                                            </div>
                                            <div class="modal-body">
                                                @if($dota->leader===$player->steamid)
                                                <h4>Copy &amp; Share this link with players you want to add to your team</h4>
                                                <input type="text" id="team" class="form-control required text-warning" value="joindota/{{$dota->id}}/{{md5($dota->image.$key)}}" readonly>
                                                @endif
                                                <div class="nk-gap"></div>
                                                    <div class="bg-dark-1">
                                                        <h3 class="nk-title h4 text-xs-center">{{$dota->name}}</h3>
                                                        <img src="https://techfest.org/gamersleague{{Storage::url( $dota->image ) }}" class="nk-img" alt="">
                                                        <div class="nk-gap"></div>
                                                        <h4>Team Members:</h4>
                                                            ...
                                                            @if($dota->leader===$player->steamid)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <br>
                                                                        @if($dota->leader!==$member->steamid)<span class="text-warning pointer" onclick="window.location.href='removedota/{{$member->steamid}}'">Remove</span>@endif
                                                                    </td>
                                                                    @endforeach
                                                                </tr>
                                                            @else
                                                        ...
                                                        @if($dota->leader === $player->steamid)
                                                            <a class="float-right text-danger" href="removedota/{{$player->steamid}}">Delete Team</a>
                                                        @else
                                                            <a href="removedota/{{$player->steamid}}" class="float-right text-danger">Leave Team</a>
                                                        @endif
                                                    </div>
                                                <div class="nk-gap"></div>
                                            </div>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title nk-title" id="myLargeModalLabel">Register for Dota 2</h4>
                                            </div>
                                            <div class="modal-body">
                                                <h3>Make a new team:</h3>
                                                <form action="{!! route('registerDOTA') !!}" method="POST" id="formUpload" enctype="multipart/form-data">
            ...
            <div class="nk-tabs">
                ...
                <div class="tab-content">
                        ...
                        <div class="nk-box-3 bg-dark-1">
                            <div class="row">
                                <div class="col-md-6">
                                    <h1>Timeline</h1>
                                    <ul>
                                        <li>Registrations Closes: 22nd November 2017</li>
                                        <li>Brackets and Schedule release: 23rd November 2017</li>
                                        <li>Online Qualifiers Starts: 24th November 2017</li>
                                        <li>LAN Playoffs: 14th-16th December 2017</li>
                                        <li>Quarter-Finals: 14th December 2017</li>
                                        <li>Semi-Finals: 15th December 2017</li>
                                        <li>Grand Finals: 16th December 2017</li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <h1>Important Details</h1>
                                    <ul>
                                        <li>Prizes Worth for Dota 2: INR 2 Lakhs</li>
                                        <li>Top 8 Teams to invited at Techfest, IIT Bombay for LAN Playoffs</li>
                                        <li>Knockout matches are Bo1, Semi-finals and finals only will be Bo3</li>
                                        <li>LAN Playoffs during 14th-16th December 2017</li>
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="tab-rules">
                        ...
                        <div class="nk-box-3 bg-dark-1">
                            <ul>
                                <li>General Game Specific Rules for Dota 2 should be followed</li>
                                ...
                                <li>To make any changes in the team roster, Team leader needs to send a mail at gamersleague@techfest.org for the same before the registrations are closed</li>
                                ...
                                <li>For any queries or reporting of any incidents in-game, kindly drop a mail at gamersleague@techfest.org</li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="nk-box-3 bg-dark-1">
                                        ...
                                        <div class="img-container" style="text-align:center">
                                            <img src="https://techfest.org/gamersleague{{Storage::url( $t->image ) }}" class="nk-img" alt="" style="margin:auto;height:300px;width: 300px;object-fit:cover;">
                                        </div>
                                        <div class="nk-gap"></div>
                                        ...
                                        <table class="tgroup">
                                            <tr>
                                                @for($x = 0; $x<count($t->players);$x+=1)
                                                    <td><img src="{{$t->players[$x]->avatarfull}}" class="nk-img-fit" alt="{{$t->players[$x]->personaname}}"></td>
                                                @endfor
